<div class='container'>
	...
	<div class='ten columns'>
		<h3>Network</h3>
		<p id="network_ip_text">Adresse IP: <?php echo $_SERVER['SERVER_ADDR']; ?></p>
		<p id="network_tx_text">Emission Réseau: <?php echo $stat['network_tx']," GB"; ?></p>
		<p id="network_rx_text">Reception Réseau: <?php echo $stat['network_rx']," GB"; ?></p>
		</p>
	</div>
</div>