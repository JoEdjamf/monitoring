...
<head>
	<meta charset="utf-8">
	<title>Etat Du Serveur | Configuration</title>
...
<!--Content-->
	...
	<form name="form" id="form" method="get" action=./index.php>
		...
		<div class='content' id='modules'>
			...
			<div class='container'>
				<h2>Configuration</h2>
				<p>Cette page vous permet de modifier les options des modules configurables inclus. Assurez-vous de cliquer sur Soumettre lorsque vous avez terminé!</p>
			</div>
